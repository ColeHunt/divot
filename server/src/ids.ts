...
/** Round-code alphabet with 0/O/1/I/L removed so codes survive being read aloud. */
...
/**
 * Round codes are typed by humans, so fold case and drop anything outside the
